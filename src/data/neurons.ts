...
export const NEURONS: NeuronData[] = [
  ...
  },
  {
    ...
    metadata: {
      ...
      media: [
        {
          type: 'image',
          src: '/images/projects/tiktok-edu/feed.svg',
          alt: 'Feed éducatif vertical',
          caption: 'Feed vertical style TikTok',
        },
        {
          type: 'image',
          src: '/images/projects/tiktok-edu/concept-card.svg',
          alt: 'Carte de concept IA',
          caption: 'Cartes générées par IA',
        },
        {
          type: 'image',
          src: '/images/projects/tiktok-edu/learning-path.svg',
          alt: 'Parcours personnalisé',
          caption: 'Apprentissage personnalisé',
        },
      ],
    },
  },
  ...
  },
  {
    ...
    metadata: {
      ...
      highlights: ['Réseau de neurones 3D navigable', 'Animations GSAP', 'React Three Fiber'],
      links: {},
    },
  },

  {
    ...
    category: 'project',
    description: 'Application de recommandation de trajets ferroviaires SNCF pilotée par le NLP',
    size: 1.3,
    color: CATEGORY_COLORS.project,
    metadata: {
      type: 'project',
